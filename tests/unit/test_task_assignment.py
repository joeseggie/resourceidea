...
class TestTaskAssignmentUtils:
    """Test Suite: app.task_assignment.utils module"""

    def test_create_task_assignment(self, session):
    ...
    def test_create_task_assignment_none_resource(self, session):
    ...
    def test_create_task_assignment_no_resource(self, session):
        """Test create_task_assignment with no resource."""
